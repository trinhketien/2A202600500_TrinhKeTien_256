...
#### Đã làm
- Setup project TypeScript + cấu hình 
...
**Thành viên:** Hồ Xuân Phú 

#### Đã làm
- Hoàn thành labs day1: tạo api key openAI, sủ dụng api key để hoàn thành bài labs như là gọi api để sử dụng model gpt-4o và gpt-4o-mini, so sánh 2 model đó, tạo được chat bot đơn giản. 
- Tham gia Ws
- Hoàn thành labs day2: Problem Scan, Quick Problem Cards, Pitch-Challenge-Vote, Phase 4 Deep-dive, Phase 5 Evaluate
- Lên ý tưởng và thiết kế hệ thống

#### Khó nhất tuần này
- Choáng ngợp với kiến thức ngày đầu
- Đồng đội liên tục rời đi và phải tìm đồng đội mới, làm chậm tiến độ
- Tìm đề bài phù hợp 

#### AI tool đã dùng
Dùng Gemini , Antigravity, ChatGpt để deep research để lên ý tưởng và thiết kế hệ thống

#### Học được
- Cách phân tích dự án một cách chuyên nghiệp từ ý tưởng ban đầu
- Tạo chatbotAi đơn giản

#### Nếu làm lại, sẽ làm khác

#### Kế hoạch tuần tới

- Triển khai phát triển đề tài đã chọn
- Sử dụng các công cự AI để tìm kiếm thêm dữ liệu, nghiên cứu tạo các Agent
- Thiết kế hệ thống: Backend FastAPI, DataBase
- Clone repo và setup